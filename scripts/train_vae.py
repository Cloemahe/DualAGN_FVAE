...
# VARIATIONAL AUTOENCODER : train to reproduce Horizon-AGN dataset ###
...
def main(args):
    ...
    Nb_step = int(args.nb_epoch * nb_images / args.b_size)
    ...
    train_loop(args.nb_epoch, dataset, dataset_valid,
               args.latent_dim, args.Beta,
               args.init_lr, Nb_step, args.decay,
               args.save, args.loop_run,
               args.type_loss, args.type_preprocessing,
               args.R, args.alpha, args.zeta, args.intensity,
               args.FWi, args.validation_every, args.test_on,
               args.num_run)
